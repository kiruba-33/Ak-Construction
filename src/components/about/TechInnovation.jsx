...
const TechInnovation = () => {
  ...
  const techItems = [
    { id: '01', title: 'Cloud Collaboration', icon: FileText, desc: 'Real-time sync of architectural designs and structural blueprints.', label: 'DIGITAL' },
    { id: '02', title: 'AI Design Optimization', icon: BrainCircuit, desc: 'Algorithms optimizing material usage and structural efficiency.', label: 'AI' },
    { id: '03', title: 'AR Field Guides', icon: HardHat, desc: 'On-site AR overlays guiding teams with precision.', label: 'ON-SITE' },
    { id: '04', title: 'IoT Jobsite Monitoring', icon: ClipboardList, desc: 'Sensors tracking safety, materials, and progress.', label: 'DATA' },
    { id: '05', title: '3D Prefabrication', icon: Building, desc: 'Precision prefabrication reducing waste and time.', label: 'TECH' },
    { id: '06', title: 'Integrated Delivery', icon: Zap, desc: 'Unified workflow from design to execution.', label: 'SYSTEM' },
  ];
